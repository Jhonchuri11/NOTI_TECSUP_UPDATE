...
<header id="header">
    <div class="d-flex flex-column">
      ...
      <div class="profile">
        ...
        <h1 class="text-light">{{ Auth::user()->alumno->nombres }}</h1>
           <!-- Mostramos información del profesor -->
           @elseif(Auth::user()->tipo === 'Profesor')
        <h1 class="text-light">{{ Auth::user()->profesor->nombres }}</h1>
           @endif
        @endif
      ...
      <nav id="navbar" class="nav-menu navbar">
        <ul>
          ...
          <li><a href="{{ route('reportes') }}" class="nav-link scrollto"><i></i> <span>Mis reportes</span></a></li>
